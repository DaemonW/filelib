...
/**
 * DAO for table "YANDEX_ACCOUNT".
*/
public class YandexAccountDao extends AbstractDao<YandexAccount, Long> {

    public static final String TABLENAME = "YANDEX_ACCOUNT";

    /**
     * Properties of entity YandexAccount.<br/>
    ...
    */
    ...
    public YandexAccountDao(DaoConfig config) {
        super(config);
    }
    
    public YandexAccountDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"YANDEX_ACCOUNT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"YANDEX_ACCOUNT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, YandexAccount entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public YandexAccount readEntity(Cursor cursor, int offset) {
        YandexAccount entity = new YandexAccount( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, YandexAccount entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(YandexAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(YandexAccount entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
