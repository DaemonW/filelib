package com.grt.filemanager.model.imp.local.archive.inter.unrar.pack.out.util;
...
public interface Registry {
	...
	String RAW_ENCODING = "unrar.pack.out.raw.format";
	...
	String SASL_PREFIX = "unrar.pack.out.sasl";
