...
public class FtpFileInfoDao extends AbstractDao<FtpFileInfo, Long> {
    ...
    /**
     * Properties of entity FtpFileInfo.<br/>
    ...
    */
    ...
    public FtpFileInfoDao(DaoConfig config) {
        super(config);
    }
    
    public FtpFileInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FTP_FILE_INFO\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_FTP_FILE_INFO_PATH_ACCOUNT_ID ON FTP_FILE_INFO" +
                " (\"PATH\",\"ACCOUNT_ID\");");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FTP_FILE_INFO\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FtpFileInfo entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public FtpFileInfo readEntity(Cursor cursor, int offset) {
        FtpFileInfo entity = new FtpFileInfo( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FtpFileInfo entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FtpFileInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FtpFileInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
