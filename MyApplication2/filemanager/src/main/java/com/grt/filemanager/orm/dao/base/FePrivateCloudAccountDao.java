...
/**
 * DAO for table "FE_PRIVATE_CLOUD_ACCOUNT".
*/
public class FePrivateCloudAccountDao extends AbstractDao<FePrivateCloudAccount, Long> {

    public static final String TABLENAME = "FE_PRIVATE_CLOUD_ACCOUNT";

    /**
     * Properties of entity FePrivateCloudAccount.<br/>
    ...
    */
    ...
    public FePrivateCloudAccountDao(DaoConfig config) {
        super(config);
    }
    
    public FePrivateCloudAccountDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FE_PRIVATE_CLOUD_ACCOUNT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FE_PRIVATE_CLOUD_ACCOUNT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FePrivateCloudAccount entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public FePrivateCloudAccount readEntity(Cursor cursor, int offset) {
        FePrivateCloudAccount entity = new FePrivateCloudAccount( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FePrivateCloudAccount entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FePrivateCloudAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FePrivateCloudAccount entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
