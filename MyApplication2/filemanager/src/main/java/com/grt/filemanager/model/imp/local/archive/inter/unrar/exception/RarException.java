 ...
 * "@":  "&#064;" 
 */
package com.grt.filemanager.model.imp.local.archive.inter.unrar.exception;
...
public class RarException extends Exception
{
	...
	public RarException(RarException e, File f)
	{
	...
	public RarException(RarExceptionType type, File f){
		super(type.name());
		this.type = type;
		this.file = f;
	}
