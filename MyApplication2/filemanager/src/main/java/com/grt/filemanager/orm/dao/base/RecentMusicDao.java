...
/**
 * DAO for table "RECENT_MUSIC".
*/
public class RecentMusicDao extends AbstractDao<RecentMusic, Long> {

    public static final String TABLENAME = "RECENT_MUSIC";

    /**
     * Properties of entity RecentMusic.<br/>
    ...
    */
    ...
    public RecentMusicDao(DaoConfig config) {
        super(config);
    }
    
    public RecentMusicDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECENT_MUSIC\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RECENT_MUSIC\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, RecentMusic entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public RecentMusic readEntity(Cursor cursor, int offset) {
        RecentMusic entity = new RecentMusic( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, RecentMusic entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(RecentMusic entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(RecentMusic entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
