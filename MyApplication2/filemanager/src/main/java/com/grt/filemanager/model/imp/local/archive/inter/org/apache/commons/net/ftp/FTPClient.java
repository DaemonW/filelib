 ...
 */
package com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp;

import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.MalformedServerReplyException;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.DefaultFTPFileEntryParserFactory;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.FTPFileEntryParserFactory;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.MLSxEntryParser;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.CRLFLineReader;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.CopyStreamAdapter;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.CopyStreamEvent;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.CopyStreamListener;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.FromNetASCIIInputStream;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.ToNetASCIIOutputStream;
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.Util;
 ...
 * from {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.SocketClient},
 * you must first connect to the server with
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.SocketClient#connect  connect }
 * before doing anything, and finally
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.SocketClient#disconnect  disconnect }
 ...
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTP#getReplyCode  getReplyCode } after
 ...
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTPReply#SERVICE_NOT_AVAILABLE FTPReply.SERVICE_NOT_AVAILABLE }
 *  response to a command.
 * When that occurs, the FTP class method encountering that reply will throw
 * an {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTPConnectionClosedException}
 * .
 ...
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTPConnectionClosedException}
 ...
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTP#getReplyCode  getReplyCode },
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTP#getReplyString  getReplyString },
 * and
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTP#getReplyStrings  getReplyStrings}.
 ...
 * can also throw a
 * {@link com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.MalformedServerReplyException}
 * , which is a subclass
 ...
 * from com.grt.otgtest.model.imp.local.archive.inter.org.apache.commons.net.FTPFileEntryParser:
 * <pre>
 *    FTPClient f = new FTPClient();
 *    f.connect(server);
 *    f.login(username, password);
 ...
 * @see FTPClientConfig
 *
 * @see com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.MalformedServerReplyException
 */
...
implements Configurable
{
     ...
     * @since 3.0
     */
    public static final String FTP_SYSTEM_TYPE = "com.grt.otgtest.model.imp.local.archive.inter.org.apache.commons.net.ftp.systemType";
     ...
     * @since 3.1
     */
    public static final String FTP_SYSTEM_TYPE_DEFAULT = "com.grt.otgtest.model.imp.local.archive.inter.org.apache.commons.net.ftp.systemType.default";
     ...
     * <pre>
     * Plan 9=Unix
     * OS410=com.grt.otgtest.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.OS400FTPEntryParser
     * </pre>
     *
     * @since 3.0
     */
     ...
     * @throws IOException
     */
    private boolean geek_storeFile(FTPCmd command, String remote, InputStream local, long length)
            throws IOException
    {
        return geek_storeFile(command.getCommand(), remote, local, length);
    }

    /**
     * add by liucheng
     */
    protected boolean geek_storeFile(String command, String remote, InputStream local, long length)
            throws IOException
    {
        ...
        try
        {
            Util.geek_copyStream(local, output, getBufferSize(),length,
    ...
    throws IOException
    {
        ...
        return new com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.SocketOutputStream(socket, output);
    }
     ...
     *
     * @see com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.FTPFileEntryParserFactory
     * @see com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.DefaultFTPFileEntryParserFactory
     */
     ...
     *      to send FTP reply code 421.  This exception may be caught either
     *      as an IOException or independently as itself.
     * @exception com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.CopyStreamException
    ...
    throws IOException
    {
        ...
        return new com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.io.SocketInputStream(socket, input);
    }
     ...
     * @throws IOException
     */
    public boolean geek_appendFile(String remote, InputStream local, long length)
            throws IOException
    {
        return geek_storeFile(FTPCmd.APPE, remote, local, length);
    }
     ...
     *                   from the server.
     * @exception com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.ParserInitializationException
     ...
     *                   com.grt.otgtest.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTPFileEntryParser
     ...
     * @see com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.DefaultFTPFileEntryParserFactory
     * @see com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.parser.FTPFileEntryParserFactory
     * @see com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTPFileEntryParser
     */
