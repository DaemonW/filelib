...
/**
 * DAO for table "ONE_DRIVE_FILE".
*/
public class OneDriveFileDao extends AbstractDao<OneDriveFile, Long> {

    public static final String TABLENAME = "ONE_DRIVE_FILE";

    /**
     * Properties of entity OneDriveFile.<br/>
    ...
    */
    ...
    public OneDriveFileDao(DaoConfig config) {
        super(config);
    }
    
    public OneDriveFileDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ONE_DRIVE_FILE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ONE_DRIVE_FILE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OneDriveFile entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OneDriveFile readEntity(Cursor cursor, int offset) {
        OneDriveFile entity = new OneDriveFile( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OneDriveFile entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OneDriveFile entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OneDriveFile entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
