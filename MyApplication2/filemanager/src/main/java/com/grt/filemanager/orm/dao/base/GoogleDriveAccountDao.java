...
/**
 * DAO for table "GOOGLE_DRIVE_ACCOUNT".
*/
public class GoogleDriveAccountDao extends AbstractDao<GoogleDriveAccount, Long> {

    public static final String TABLENAME = "GOOGLE_DRIVE_ACCOUNT";

    /**
     * Properties of entity GoogleDriveAccount.<br/>
    ...
    */
    ...
    public GoogleDriveAccountDao(DaoConfig config) {
        super(config);
    }
    
    public GoogleDriveAccountDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GOOGLE_DRIVE_ACCOUNT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GOOGLE_DRIVE_ACCOUNT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, GoogleDriveAccount entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public GoogleDriveAccount readEntity(Cursor cursor, int offset) {
        GoogleDriveAccount entity = new GoogleDriveAccount( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, GoogleDriveAccount entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(GoogleDriveAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(GoogleDriveAccount entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
