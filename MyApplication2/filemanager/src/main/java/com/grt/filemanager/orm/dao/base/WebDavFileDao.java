...
/**
 * DAO for table "WEB_DAV_FILE".
*/
public class WebDavFileDao extends AbstractDao<WebDavFile, Long> {

    public static final String TABLENAME = "WEB_DAV_FILE";

    /**
     * Properties of entity WebDavFile.<br/>
    ...
    */
    ...
    public WebDavFileDao(DaoConfig config) {
        super(config);
    }
    
    public WebDavFileDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WEB_DAV_FILE\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_WEB_DAV_FILE_PATH_ACCOUNT_ID ON WEB_DAV_FILE" +
                " (\"PATH\",\"ACCOUNT_ID\");");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WEB_DAV_FILE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, WebDavFile entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public WebDavFile readEntity(Cursor cursor, int offset) {
        WebDavFile entity = new WebDavFile( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, WebDavFile entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(WebDavFile entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(WebDavFile entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
