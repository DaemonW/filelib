...
public class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = ApiPresenter.getContext().getPackageManager().getPackageInfo(ApiPresenter.getContext().getPackageName(), 0);
            if (pi != null) {
        ...
        CRASH_HEAD = "Device Manufacturer: " + Build.MANUFACTURER +// 设备厂商
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && ApiPresenter.getContext().getExternalCacheDir() != null)
            defaultDir = ApiPresenter.getContext().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = ApiPresenter.getContext().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
