...
import com.grt.filemanager.model.imp.local.archive.inter.unrar.pack.out.util.Registry;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.pack.out.util.Util;
...
public final class Rijndael extends BaseCipher {
	...
	static {
		...
		if (DEBUG && debuglevel > 8) {
			...
			for (i = 0; i < 16; i++) {
				for (j = 0; j < 16; j++) {
					System.out
							.print("0x" + Util.toString(S[i * 16 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T1[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T2[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T3[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T4[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T5[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T6[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T7[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T8[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(U1[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(U2[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(U3[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
	...
	private static void rijndaelEncrypt(byte[] in, int inOffset, byte[] out,
		...
		if (DEBUG && debuglevel > 6) {
			System.out.println("CT="
					+ Util.toString(out, outOffset - bs + 1, bs));
			System.out.println();
		}
	}
	...
	private static void aesEncrypt(byte[] in, int i, byte[] out, int j,
			Object key) {
		...
		int t0 = (in[i++] << 24 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF))
				^ Ker[0];
		int t1 = (in[i++] << 24 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF))
				^ Ker[1];
		int t2 = (in[i++] << 24 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF))
				^ Ker[2];
		int t3 = (in[i++] << 24 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF))
				^ Ker[3];
	...
	private static void aesDecrypt(byte[] in, int i, byte[] out, int j,
			Object key) {
