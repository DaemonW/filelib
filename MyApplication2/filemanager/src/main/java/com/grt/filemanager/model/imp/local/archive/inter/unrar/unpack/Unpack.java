 ...
 * "@":  "&#064;" 
 */
package com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack;
...
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.decode.Compress;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.ppm.BlockTypes;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.ppm.ModelPPM;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.ppm.SubAllocator;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.vm.BitInput;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.vm.RarVM;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.vm.VMPreparedProgram;
...
public final class Unpack extends Unpack20 {
    ...
    public void doUnpack(int method, boolean solid, File f) throws IOException,
	    RarException {
    ...
    private void unpack29(boolean solid, File f) throws IOException, RarException {
	...
	while (true) {
	    ...
	    // BaseArchive.MAXWINMASK)+":"+wrPtr+":"+unpPtr);
    ...
    private void UnpWriteBuf(File f) throws IOException, RarException {
