...
/**
 * DAO for table "BOX_ACCOUNT".
*/
public class BoxAccountDao extends AbstractDao<BoxAccount, Long> {

    public static final String TABLENAME = "BOX_ACCOUNT";

    /**
     * Properties of entity BoxAccount.<br/>
    ...
    */
    ...
    public BoxAccountDao(DaoConfig config) {
        super(config);
    }
    
    public BoxAccountDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOX_ACCOUNT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BOX_ACCOUNT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, BoxAccount entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public BoxAccount readEntity(Cursor cursor, int offset) {
        BoxAccount entity = new BoxAccount( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, BoxAccount entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(BoxAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(BoxAccount entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
