...
import com.grt.filemanager.model.imp.local.archive.inter.org.apache.commons.net.ftp.FTPClient;
...
public class SocketInputStream extends FilterInputStream
{
    ...
    public void close() throws IOException
    {
        super.close();
        __socket.close();
        __client.completePendingCommand();
    }
