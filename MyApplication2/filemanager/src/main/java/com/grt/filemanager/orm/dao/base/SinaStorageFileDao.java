...
/**
 * DAO for table "SINA_STORAGE_FILE".
*/
public class SinaStorageFileDao extends AbstractDao<SinaStorageFile, Long> {

    public static final String TABLENAME = "SINA_STORAGE_FILE";

    /**
     * Properties of entity SinaStorageFile.<br/>
    ...
    */
    ...
    public SinaStorageFileDao(DaoConfig config) {
        super(config);
    }
    
    public SinaStorageFileDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SINA_STORAGE_FILE\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_SINA_STORAGE_FILE_PATH_ACCOUNT_ID ON SINA_STORAGE_FILE" +
                " (\"PATH\",\"ACCOUNT_ID\");");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SINA_STORAGE_FILE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SinaStorageFile entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public SinaStorageFile readEntity(Cursor cursor, int offset) {
        SinaStorageFile entity = new SinaStorageFile( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SinaStorageFile entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SinaStorageFile entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SinaStorageFile entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
