...
/**
 * DAO for table "DROPBOX_ACCOUNT".
*/
public class DropboxAccountDao extends AbstractDao<DropboxAccount, Long> {

    public static final String TABLENAME = "DROPBOX_ACCOUNT";

    /**
     * Properties of entity DropboxAccount.<br/>
    ...
    */
    ...
    public DropboxAccountDao(DaoConfig config) {
        super(config);
    }
    
    public DropboxAccountDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DROPBOX_ACCOUNT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DROPBOX_ACCOUNT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DropboxAccount entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DropboxAccount readEntity(Cursor cursor, int offset) {
        DropboxAccount entity = new DropboxAccount( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DropboxAccount entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DropboxAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DropboxAccount entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
