...
import com.grt.filemanager.model.imp.local.archive.inter.unrar.exception.RarException.RarExceptionType;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.io.IReadOnlyAccess;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.io.ReadOnlyAccessFile;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.AVHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.BaseBlock;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.BlockHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.CommentHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.EAHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.EndArcHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.FileHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.MacInfoHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.MainHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.MarkHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.ProtectHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.SignHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.SubBlockHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.UnixOwnersHeader;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.rarfile.UnrarHeadertype;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.ComprDataIO;
import com.grt.filemanager.model.imp.local.archive.inter.unrar.unpack.Unpack;

/**
 * The Main Rar Class; represents a rar BaseArchive
 * 
...
public class Archive implements Closeable {
	 ...
	 * @throws RarException
	 */
	public void extractFile(FileHeader hd, OutputStream os, File f) throws RarException {
		if (!headers.contains(hd)) {
			throw new RarException(RarExceptionType.headerNotInArchive);
		}
		try {
			doExtractFile(hd, os, f);
		} catch (Exception e) {
	...
	private void doExtractFile(FileHeader hd, OutputStream os, File f)
			throws RarException, IOException {
		dataIO.init(os);
		dataIO.init(hd);
		...
		try {
			unpack.doUnpack(hd.getUnpVersion(), hd.isSolid(), f);
			// Verify file CRC
