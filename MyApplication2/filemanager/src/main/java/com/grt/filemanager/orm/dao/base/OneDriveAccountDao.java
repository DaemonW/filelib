...
/**
 * DAO for table "ONE_DRIVE_ACCOUNT".
*/
public class OneDriveAccountDao extends AbstractDao<OneDriveAccount, Long> {

    public static final String TABLENAME = "ONE_DRIVE_ACCOUNT";

    /**
     * Properties of entity OneDriveAccount.<br/>
    ...
    */
    ...
    public OneDriveAccountDao(DaoConfig config) {
        super(config);
    }
    
    public OneDriveAccountDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ONE_DRIVE_ACCOUNT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ONE_DRIVE_ACCOUNT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OneDriveAccount entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OneDriveAccount readEntity(Cursor cursor, int offset) {
        OneDriveAccount entity = new OneDriveAccount( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OneDriveAccount entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OneDriveAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OneDriveAccount entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
