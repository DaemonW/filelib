...
/**
 * DAO for table "DOWNLOAD_MUSIC".
*/
public class DownloadMusicDao extends AbstractDao<DownloadMusic, Long> {

    public static final String TABLENAME = "DOWNLOAD_MUSIC";

    /**
     * Properties of entity DownloadMusic.<br/>
    ...
    */
    ...
    public DownloadMusicDao(DaoConfig config) {
        super(config);
    }
    
    public DownloadMusicDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DOWNLOAD_MUSIC\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DOWNLOAD_MUSIC\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DownloadMusic entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DownloadMusic readEntity(Cursor cursor, int offset) {
        DownloadMusic entity = new DownloadMusic( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DownloadMusic entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DownloadMusic entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DownloadMusic entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
