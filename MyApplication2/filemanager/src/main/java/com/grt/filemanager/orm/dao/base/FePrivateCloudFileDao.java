...
/**
 * DAO for table "FE_PRIVATE_CLOUD_FILE".
*/
public class FePrivateCloudFileDao extends AbstractDao<FePrivateCloudFile, Long> {

    public static final String TABLENAME = "FE_PRIVATE_CLOUD_FILE";

    /**
     * Properties of entity FePrivateCloudFile.<br/>
    ...
    */
    ...
    public FePrivateCloudFileDao(DaoConfig config) {
        super(config);
    }
    
    public FePrivateCloudFileDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FE_PRIVATE_CLOUD_FILE\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_FE_PRIVATE_CLOUD_FILE_PATH_ACCOUNT_ID ON FE_PRIVATE_CLOUD_FILE" +
                " (\"PATH\",\"ACCOUNT_ID\");");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FE_PRIVATE_CLOUD_FILE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FePrivateCloudFile entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public FePrivateCloudFile readEntity(Cursor cursor, int offset) {
        FePrivateCloudFile entity = new FePrivateCloudFile( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FePrivateCloudFile entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FePrivateCloudFile entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FePrivateCloudFile entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
