...
/**
 * DAO for table "MIX_CLOUD_ACCOUNT".
*/
public class MixCloudAccountDao extends AbstractDao<MixCloudAccount, Long> {

    public static final String TABLENAME = "MIX_CLOUD_ACCOUNT";

    /**
     * Properties of entity MixCloudAccount.<br/>
    ...
    */
    ...
    public MixCloudAccountDao(DaoConfig config) {
        super(config);
    }
    
    public MixCloudAccountDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MIX_CLOUD_ACCOUNT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MIX_CLOUD_ACCOUNT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MixCloudAccount entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MixCloudAccount readEntity(Cursor cursor, int offset) {
        MixCloudAccount entity = new MixCloudAccount( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MixCloudAccount entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MixCloudAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MixCloudAccount entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
